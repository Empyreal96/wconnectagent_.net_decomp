...
// Type: Microsoft.Arcadia.Debugging.AdbAgent.Portable.AdbMessageStrings
...
namespace Microsoft.Arcadia.Debugging.AdbAgent.Portable
{
  internal sealed class AdbMessageStrings
  {
    ...
    private const uint ErrorInstallRegistrationFailure = 2147958006;
    ...
    public static string FromPackageManagerInstallResult(PackageDeploymentResult result)
    {
      ...
      string str = AdbMessageStrings.GetAndroidPackageManagerErrorString(hresult);
      if (string.IsNullOrWhiteSpace(str))
        str = AdbMessageStrings.GetWindowsPackageManagerErrorString(hresult);
      if (string.IsNullOrWhiteSpace(str))
        str = AdbMessageStrings.GenerateUnknownInstallErrorString(hresult);
      return str;
    }
    ...
    private static string GenerateUnknownInstallErrorString(int errorCode) => "Failure [INSTALL_FAILED_(" + (object) errorCode + ")]";
  }
}
