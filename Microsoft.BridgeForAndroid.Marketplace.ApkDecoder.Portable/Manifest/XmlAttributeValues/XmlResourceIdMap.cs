...
// Type: Microsoft.Arcadia.Marketplace.Decoder.Portable.Manifest.XmlAttributeValues.XmlResourceIdMap
...
namespace Microsoft.Arcadia.Marketplace.Decoder.Portable.Manifest.XmlAttributeValues
{
  ...
  {
    private static readonly Dictionary<string, string> ResourcesMap = new Dictionary<string, string>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase)
    {
      {
        "0x01010000",
        "theme"
    ...
    public static string MapXmlAttributeResourceId(string resourceId)
    {
      ...
      XmlResourceIdMap.ResourcesMap.TryGetValue(resourceId, out str);
      return XmlResourceIdMap.ResourcesMap[resourceId];
    }
  }
}
